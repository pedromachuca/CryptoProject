...
public class TestSha3 {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("\n*** Key Generation ***");
    System.out.println("Wallet 1 = vk1 = ");
    System.out.println("Wallet 2 = vk2 = ");
    System.out.println("Wallet 3 = vk3 = ");

    try{

      KeyPair pair =generateKeyPair();
      PrivateKey sk1 = pair.getPrivate();
      PublicKey vk1 = pair.getPublic();
      System.out.println("sk1 :"+sk1);
      System.out.println("vk1 :"+vk1);
  ...
  public static KeyPair generateKeyPair()throws GeneralSecurityException{
    ...
    keyGen.initialize(384, new SecureRandom());
